...
var (
	baseSegmentCharacterFormat = map[string]field{
		...
		"CorrectionIndicator":           {6, 1, alphanumeric, required},
		...
		"CreditLimit":                   {83, 9, numeric, applicable},
		...
		"DateFirstDelinquency":          {189, 8, date | zeroFill, applicable},
		...
		"SocialSecurityNumber":          {297, 9, numeric, applicable},
		"DateBirth":                     {306, 8, date, required},
		"TelephoneNumber":               {314, 10, numeric, nullable},
		"AssociationCode":               {315, 1, alphanumeric, applicable},
		...
		"ZipCode":                       {415, 9, alphanumeric, applicable},
		"PostalCode":                    {415, 9, alphanumeric, applicable},
	...
	baseSegmentPackedFormat = map[string]field{
		...
		"CreditLimit":                   {74, 5, packedNumber, applicable},
		...
		"DateFirstDelinquency":          {149, 5, packedDate | zeroFill, applicable},
		...
		"SocialSecurityNumber":          {248, 5, packedNumber, applicable},
		"DateBirth":                     {253, 5, packedDate, required},
		"TelephoneNumber":               {258, 6, packedNumber, nullable},
		"AssociationCode":               {259, 1, alphanumeric, applicable},
		...
		"ZipCode":                       {355, 9, alphanumeric, applicable},
		"PostalCode":                    {415, 9, alphanumeric, applicable},
	...
	j1SegmentFormat = map[string]field{
		...
		"SocialSecurityNumber":         {69, 9, numeric, applicable},
	...
	j2SegmentFormat = map[string]field{
		...
		"PostalCode":                   {187, 9, alphanumeric, applicable},
